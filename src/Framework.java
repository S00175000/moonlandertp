...
public class Framework extends Canvas {
   ...
   /**
    ...
    public void Draw(Graphics2D g2d)
    {
        switch (gameState)
        {
            ...
            case MAIN_MENU:
                ...
                g2d.drawString("Use right left up keys to controle the rocket.", frameWidth / 4 - 70, frameHeight / 2);
                g2d.drawString("Press 1 for level easy, 2 for normal level, 3 for difficult level", frameWidth / 4 - 70, frameHeight / 2 + 30);
    ...
    private void replayGame()
    {
        ...
        // We change game status to come back to the menu.
        gameState = GameState.MAIN_MENU;
    }
    /**
