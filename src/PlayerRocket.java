...
public class PlayerRocket {
	...
	private final int SOUND_LANDED = 2;
	private final int SOUND_REACTOR = 3;
    /**
	...
	public void playit(int soundRequired) {
		...
		case SOUND_LANDED:
			fn = "./src/moon_lander/resources/sounds/landed.wav";
			break;
			
		case SOUND_REACTOR:
			fn = "./src/moon_lander/resources/sounds/reactor.wav";
			break;
		default:
			break;
		}
